...
namespace LBC
{
    class Cpu68000 : CPU
    {
        ...
        public override void Alloc(string name, int value)
        {
        ...
        public override void LoadConst(string value)
        {
            EmitLn("MOVE #" + value + ",D0");
        }

        public override void LoadVar(string name)
        {
        ...
        public override void SetLessOrEqual()
        {
            EmitLn("SGE D0");
            EmitLn("EXT D0");
        }

        public override void SetGreaterOrEqual()
        {
            EmitLn("SLE D0");
            EmitLn("EXT D0");
        }
