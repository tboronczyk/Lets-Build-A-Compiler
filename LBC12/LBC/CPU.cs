namespace LBC
{
    abstract class CPU
    {
        ...
        public abstract void Alloc(string name, int value);
        ...
        public abstract void LoadConst(string value);

        // Load a variable to primary register
        public abstract void LoadVar(string name);
        ...
        // Set primary if compare was <=
        public abstract void SetLessOrEqual();

        // Set primary if compare was >=
        public abstract void SetGreaterOrEqual();
